...
--
-- Host: Localhost
-- Generation Time: Mar 13, 2014 at 10:17 PM
...
--
-- Dumping data for table `mini_events_score_log`
--

INSERT INTO `mini_events_score_log` (`team_id`, `mini_event_name`, `timestamp_of_entry`, `mini_event_amt_won`, `entry_by_council_member_name`, `entry_by_imei_num`) VALUES
(1, 'Cricket (Nike)', '2014-03-07 22:16:06', 1000, 'Ritesh', '358894042526180'),
(1, 'Field Placement', '2014-03-07 22:30:03', 1000, 'Ritesh', '358794043002985'),
(1, 'Field Placement', '2014-03-07 22:30:19', 1000, 'Ritesh', '358794043002985'),
(2, 'Cricket (Nike)', '2014-03-07 22:17:29', 2000, 'Ritesh', '358894042526180'),
(2, 'Cricket (Nike)', '2014-03-07 22:31:15', 1000, 'Ritesh', '358894042526180'),
(3, 'Cricket (Nike)', '2014-03-07 22:17:29', 2000, 'Ritesh', '358794043002985');
COMMIT;

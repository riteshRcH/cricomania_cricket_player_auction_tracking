...
public class AndroidLikeToast extends JDialog {
    ...
    public AndroidLikeToast(JFrame owner){
    	super(owner);
    	mOwner = owner;
    }
	...
	public static AndroidLikeToast makeText(JFrame owner, String text){
		return makeText(owner, text, LENGTH_SHORT);
	}
	
	public static AndroidLikeToast makeText(JFrame owner, String text, Style style){
		return makeText(owner, text, LENGTH_SHORT, style);
	}
    
    public static AndroidLikeToast makeText(JFrame owner, String text, int duration){
    	return makeText(owner, text, duration, Style.NORMAL);
    }
    
    public static AndroidLikeToast makeText(JFrame owner, String text, int duration, Style style){
    	AndroidLikeToast toast = new AndroidLikeToast(owner);
    	toast.mText = text;
    ...
    /*public static void main(String... args){
		...
		public void actionPerformed(ActionEvent e) {
			AndroidLikeToast.makeText(frame, "Annotations were successfully saved.", Style.SUCCESS).display();
		}
	});
